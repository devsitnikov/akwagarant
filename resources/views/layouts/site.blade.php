...
<head>
    ...
    <title>{{ isset($title) ? $title : 'Компания Аквагарант. Монтаж отопления в коттедже' }}</title>
    <meta name="description" content="{{isset($description) ? $description : 'Компания Аквагарант. Монтаж отопления в коттедже'}}">
    <!-- CSRF Token -->
